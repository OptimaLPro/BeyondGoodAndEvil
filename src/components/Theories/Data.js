...
export const theories = [
    {
        ...
        bold_description: ["the best action is the one that maximizes overall happiness or pleasure."],
        left: YellowLeft,
        right: Blue,
    },
    {
        ...
        bold_description: ["According to this theory, certain actions are intrinsically right or wrong, regardless of their consequences."],
        left: PinkLeft,
        right: Green,
    },
    {
        ...
        bold_description: ["virtue ethics focuses on the character and virtues of the moral agent rather than specific actions."],
        left: BlueLeft,
        right: Yellow,
    },
    {
        ...
        bold_description: ["when choosing between different numbers of people, it might be more ethical to flip a coin, treating each life as equally valuable."],
        left: GreenLeft,
        right: Pink,
    },
];
