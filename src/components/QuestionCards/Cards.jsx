...
function Advanced() {
    ...
    const swiped = (direction, cardID, index) => {
        if (cards[cardID].subquestions) {
            console.log(cards[cardID].subquestions);
        }
        console.log(index);
            ...
            <div className="flex flex-col">
                <div className="mx-4 mt-4 mb-[20px] flex items-center">
                    ...
                    <div className="w-1/3 justify-center flex">
                        <span className="joystix-font text-white tracking-widest">{currentID}/{cards.length}</span>
                    </div>
                    <div className="w-1/3">
                    </div>
                </div>
            ...
            <div className='w-full flex flex-col justify-end flex-grow fixed bottom-0'>
                <div className=' h-[74px] bg-[#F6F3F1] flex' >
                    <div className='flex w-full justify-between mx-5'>
                        ...
                        <img src={SkipIcon} alt="Skip Icon" className="skip-icon mt-[4px]" onClick={() => goBack()} /> 
